...
class masseuseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->config = $this->getters->getSetting('page_masseuse') ?? ['count_per_page' => 20, 'watermark' => 0, 'template' => 'style_1'];
    }

    public function index()
    {
        $data['h1'] = __('catalog/page_titles.post_masseuse_h1');
        $data['title'] = __('catalog/page_titles.post_masseuse_t');
        $data['description'] = __('catalog/page_titles.post_masseuse_d');
        $this->getters->setMetaInfo(title: $data['title'], description: $data['description'], url: route('client.post.masseuse'));
        ...
        $breadcrumbs = [
            ['link' => route('client.post.masseuse'), 'title' => __('catalog/page_titles.post_masseuse')]
        ];
