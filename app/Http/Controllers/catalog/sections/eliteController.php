...
class eliteController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->config = $this->getters->getSetting('page_elite') ?? ['count_per_page' => 20, 'watermark' => 0, 'template' => 'style_1'];
    }

    public function index()
    {
        $data['h1'] = __('catalog/page_titles.post_elite_h1');
        $data['title'] = __('catalog/page_titles.post_elite_t');
        $data['description'] = __('catalog/page_titles.post_elite_d');
        $this->getters->setMetaInfo(title: $data['title'], description: $data['description'], url: route('client.post.elite'));
        ...
        $breadcrumbs = [
            ['link' => route('client.post.elite'), 'title' => __('catalog/page_titles.post_elite')]
        ];
