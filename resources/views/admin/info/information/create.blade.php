...
@section('content')
    <main id="main-container">
        <div class="bg-image" style="background-image: url('{{ url('images/admin/photo16@2x.jpg') }}');">
            <div class="content py-6">
                <h3 class="text-center text-white mb-0">
                    {{ __('admin/page_titles.information_add') }}
                </h3>
            </div>
        </div>
        ...
        <div class="content">
            <form action="{{ route('information.store') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.information_add') }}</h3>
                    ...
                    <div class="block-content">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" class="form-control" id="input-title" placeholder="{{ __('admin/info/information.title') }}">
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="input-desc">{{ __('admin/info/information.desc') }}</label>
                            <textarea class="form-control desc" id="input-desc" name="desc" rows="4" placeholder="{{ __('admin/info/information.desc') }}">{{ old('desc') }}</textarea>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="input-meta_title">{{ __('admin/info/information.meta_title') }}</label>
                            <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="form-control" id="input-meta_title" placeholder="{{ __('admin/info/information.meta_title') }}">
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="input-meta-description">{{ __('admin/info/information.meta_description') }}</label>
                            <textarea class="form-control" id="input-meta-description" name="meta_description" rows="4" placeholder="{{ __('admin/info/information.meta_description') }}">{{ old('meta_description') }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="seo_url" value="{{ old('seo_url') }}" class="form-control" id="input-seo_url" placeholder="{{ __('admin/info/information.seo_url') }}">
                                </div>
                            </div>
                            <div class="col-sm-4 col-12">
                                <div class="mb-4">
                                    <label class="form-label" for="input-views">{{ __('admin/info/information.views') }}</label>
                                    <input type="number" name="views" value="{{ old('views') ?? 0 }}" class="form-control" id="input-views" placeholder="{{ __('admin/info/information.views') }}">
                                </div>
                            </div>
                            <div class="col-sm-4 col-12">
                            ...
                            <div class="col-sm-4 col-12">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-in_menu-in_menu-1" name="in_menu" value="1" {{ (old('in_menu') == 1) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-in_menu-in_menu-1">{{ __('lang.status_on') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-in_menu-in_menu-2" name="in_menu" value="0" {{ (old('in_menu') == 0) ? 'checked' : '' }}>
