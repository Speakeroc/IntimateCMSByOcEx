    ...
    <main id="main-container">
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">{{ __('admin/page_titles.zone') }}</h1>
                </div>
            </div>
        </div>
        ...
        <div class="content">
                ...
                <div class="block-content pt-0">
                    <form action="{{ route('zone.index') }}" method="get">
                        <div class="row">
                            <div class="col-sm-3 col-12 my-2">
                                <div class="form-group">
                                    <label>{{ __('admin/location/zone.city') }}</label>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @if($data['filtered'])
                                <a href="{{ route('zone.index') }}" class="btn btn-danger">{{ __('lang.reset') }}</a>
                            @endif
                        </div>
                    </form>
                </div>
            ...
            <div class="block block-rounded">
                <div class="block-header">
                    <h3 class="block-title">{{ __('admin/location/zone.list') }}</h3>
                    <div class="block-options">
                        ...
                        <a href="{{ route('zone.create') }}" class="btn btn-sm btn-primary">{{ __('buttons.add') }}</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-vcenter">
                            ...
                            <tr>
                                ...
                                <th>{{ __('admin/location/zone.title') }}</th>
                                <th style="width: 15%;">{{ __('admin/location/zone.city') }}</th>
                                <th style="width: 15%;">{{ __('admin/location/zone.status') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('zone.destroy', $item['id']) }}" method="post">
                                            ...
                                            @method('DELETE')
                                            <div class="btn-group">
                                                <a href="{{ route('zone.edit', $item['id']) }}" class="btn btn-alt-info">
    ...
    <script>
        $(document).ready(function () {
            ...
            deleteBtn.on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("admin.zone.massDelete") }}',
                    method: 'POST',
