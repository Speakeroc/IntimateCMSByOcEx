        ...
        <div class="bg-image" style="background-image: url('{{ url('images/admin/photo16@2x.jpg') }}');">
            <div class="content py-6">
                <h3 class="text-center text-white mb-0">
                    {{ __('admin/page_titles.zone_add') }}
                </h3>
            </div>
        </div>

        <div class="content">
            <form action="{{ route('zone.store') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.zone_add') }}</h3>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" id="input-title" placeholder="{{ __('admin/location/zone.title') }}">
                                    @error('title')
                                    <script>
                                ...
                                <div class="form-floating mb-4">
                                    ...
                                    <label class="form-label" for="input-status">{{ __('admin/location/zone.status') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
