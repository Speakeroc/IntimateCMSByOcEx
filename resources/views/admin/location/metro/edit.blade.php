        ...
        <div class="bg-image" style="background-image: url('{{ url('images/admin/photo16@2x.jpg') }}');">
            <div class="content py-6">
                <h3 class="text-center text-white mb-0">
                    {{ __('admin/page_titles.metro_edit') }}
                </h3>
            </div>
        </div>

        <div class="content">
            <form action="{{ route('metro.update', $data['id']) }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.metro_edit') }}</h3>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') ?? $data['title'] }}" class="form-control @error('title') is-invalid @enderror" id="input-title" placeholder="{{ __('admin/location/metro.title') }}">
                                    @error('title')
                                    <script>
