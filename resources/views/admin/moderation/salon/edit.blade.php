...
@section('content')
    <main id="main-container">
        ...
        <div class="content">
            <form action="{{ route('salon_moderation.update', $data['id']) }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-12">
                                ...
                                <div class="d-flex justify-content-center position-relative mb-2">
                                    <div id="upload-container-main" class="upload-container" style="display: {{ $data['image_main'] ? 'none' : 'flex' }}">
                                        <svg class="ex_upload_preview"><use xlink:href="#icon-preview"></use></svg>
                                    </div>
                                    <div id="preview-container-main" class="preview-container" style="display: {{ $data['image_main'] ? 'flex' : 'none' }};">
                                        <img id="preview-image-main" src="{{ $data['image_main'] }}" alt="Preview" class="preview-img"/>
                                    </div>
                                    ...
                                    <input type="hidden" name="images[main]" id="image-path-main" value="{{ $data['image_main'] }}">
                                </div>
                                <!-- //Photo And Parameters -->
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select class="form-select" id="select-user" name="user_id">
                                                @foreach($data['main_data']['users'] as $user)
                                                    <option value="{{ $user['id'] }}" @if($data['user_id'] == $user['id']) selected @endif>{{ __('admin/salon/salon.user_r', ['login' => $user['login'], 'email' => $user['email']]) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!-- //Users -->
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="input-title" name="title" value="{{ $data['title'] }}" placeholder="{{ __('admin/salon/salon.title_p') }}">
                                        </div>
                                        <!-- //Title -->
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4 col-12">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_day_in_one'] }}</div></div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_day_out_one'] }}</div></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/salon/salon.two_hours') }}</div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_day_in_two'] }}</div></div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_day_out_two'] }}</div></div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-12">
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/salon/salon.one_hour') }}</div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_night_in_one'] }}</div></div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_night_out_one'] }}</div></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/salon/salon.night') }}</div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_night_in_night'] }}</div></div>
                                    <div class="col-sm-4 col-4 text-center"><div>{{ $data['price_night_out_night'] }}</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @php $old_photos = $data['image_photos']; @endphp
                @php $old_photos_count = count($data['image_photos']); @endphp
                @if($old_photos_count)
                    <div class="block block-rounded">
