...
@section('content')
    <main id="main-container">
        ...
        <div class="content">
            <form action="{{ route('post.store') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="random_id" id="input-random-id" value="{{ old('random_id') ?? rand(100000, 9999999) }}">
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.post_add') }}</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-12">
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select class="form-select" id="select-user" name="user_id">
                                                @foreach($data['main_data']['users'] as $user)
                                                    <option value="{{ $user['id'] }}" @if((old('user_id') ?? $data['this_user_id']) == $user['id']) selected @endif>{{ __('admin/posts/post.user_r', ['login' => $user['login'], 'email' => $user['email']]) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!-- //Users -->
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="input-name" name="name" value="{{ old('name') }}" placeholder="{{ __('admin/posts/post.name_p') }}" required>
                                        </div>
                                        <!-- //Name -->
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="input-phone" name="phone" value="{{ old('phone') }}" placeholder="+7 (___) ___-__-__" required>
                                        </div>
                                        <!-- //Phone -->
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-y-2 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="input-call-time-type-one" name="call_time_type" value="1" {{ (old('call_time_type') == 1) ? 'checked' : '' }}{{ (!old('call_time_type')) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="input-call-time-type-one">{{ __('admin/posts/post.call_time_hours') }}</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="input-call-time-type-two" name="call_time_type" value="2" {{ (old('call_time_type') == 2) ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <select class="form-select" id="select-call-time-from" name="call_time[time_from]">
                                                        @for ($i = 0; $i <= 24; $i++)
                                                            <option value="{{ $i }}" {{ (old('call_time.time_from') == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <select class="form-select" id="select-call-time-to" name="call_time[time_to]">
                                                        @for ($i = 0; $i <= 24; $i++)
                                                            <option value="{{ $i }}" {{ (old('call_time.time_to') == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <select class="form-select" id="select-client-age-min" name="client_age[min]">
                                                        @for ($i = 18; $i <= 99; $i++)
                                                            <option value="{{ $i }}" {{ (old('client_age.min') == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <select class="form-select" id="select-client-age-max" name="client_age[max]">
                                                        @for ($i = 18; $i <= 99; $i++)
                                                            <option value="{{ $i }}" {{ ((old('client_age.max') ?? 35) == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                <div class="form-check form-check-inline ms-0 me-2">
                                                    <input class="form-check-input" type="checkbox" value="1" id="input-answering-call" name="call_time[answering_to][]" {{ (old('call_time.answering_to') && in_array(1, old('call_time.answering_to'))) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="input-answering-call">{{ __('admin/posts/post.answering_call') }}</label>
                                                </div>
                                                <div class="form-check form-check-inline ms-0 me-2">
                                                    <input class="form-check-input" type="checkbox" value="2" id="input-answering-sms" name="call_time[answering_to][]" {{ (old('call_time.answering_to') && in_array(2, old('call_time.answering_to'))) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="input-answering-sms">{{ __('admin/posts/post.answering_sms') }}</label>
                                                </div>
                                                <div class="form-check form-check-inline ms-0 me-2">
                                                    <input class="form-check-input" type="checkbox" value="3" id="input-answering-messengers" name="call_time[answering_to][]" {{ (old('call_time.answering_to') && in_array(3, old('call_time.answering_to'))) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="input-delete-code" name="delete_code" value="{{ old('delete_code') }}" placeholder="{{ __('admin/posts/post.delete_place') }}" required>
                                        </div>
                                        <!-- //Delete code -->
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <!-- Polee -->
                                        @php $polee_status = old('messengers.polee.status') ?? null; @endphp
                                        @php $polee_content = old('messengers.polee.content') ?? null; @endphp
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="row">
                                            <div class="col-sm-4 col-6 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="input-age" name="age" value="{{ old('age') }}" placeholder="{{ __('admin/posts/post.prefix_age') }}" required>
                                            </div>
                                            <div class="col-sm-4 col-6 mb-2">
                                                <label class="form-label" for="input-weight">{{ __('admin/posts/post.weight') }}</label>
                                                <input type="text" class="form-control" id="input-weight" name="weight" value="{{ old('weight') }}" placeholder="{{ __('admin/posts/post.prefix_weight') }}" required>
                                            </div>
                                            <div class="col-sm-4 col-6 mb-2 {{ ($data['post_display_cloth']) ? '' : 'd-none' }}">
                                                ...
                                                <input type="text" class="form-control" id="input-cloth" name="cloth" value="{{ old('cloth') }}" placeholder="{{ __('admin/posts/post.prefix_size') }}">
                                            </div>
                                            <div class="col-sm-4 col-6 mb-2">
                                                <label class="form-label" for="input-height">{{ __('admin/posts/post.height') }}</label>
                                                <input type="text" class="form-control" id="input-height" name="height" value="{{ old('height') }}" placeholder="{{ __('admin/posts/post.prefix_sm') }}" required>
                                            </div>
                                            <div class="col-sm-4 col-6 mb-2">
                                                <label class="form-label" for="input-breast">{{ __('admin/posts/post.breast') }}</label>
                                                <input type="text" class="form-control" id="input-breast" name="breast" value="{{ old('breast') }}" placeholder="{{ __('admin/posts/post.prefix_size') }}" required>
                                            </div>
                                            <div class="col-sm-4 col-6 mb-2 {{ ($data['post_display_shoes']) ? '' : 'd-none' }}">
                                                ...
                                                <input type="text" class="form-control" id="input-shoes" name="shoes" value="{{ old('shoes') }}" placeholder="{{ __('admin/posts/post.prefix_size') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                            ...
                                            <div class="col-sm-6 col-12 mb-2">
                                                ...
                                                <select class="form-select" id="select-nationality" name="nationality">
                                                    @foreach($data['main_data']['nationality'] as $item)
                                                        <option value="{{ $item['id'] }}" {{ (old('nationality') == $item['id']) ? 'selected' : '' }}>{{ $item['title'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6 col-12 mb-2">
                                                ...
                                                <select class="form-select" id="select-body-type" name="body_type">
                                                    @foreach($data['main_data']['body_type'] as $item)
                                                        <option value="{{ $item['id'] }}" {{ (old('body_type') == $item['id']) ? 'selected' : '' }}>{{ $item['title'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6 col-12 mb-2">
                                                ...
                                                <select class="form-select" id="select-hair-color" name="hair_color">
                                                    @foreach($data['main_data']['hair_color'] as $item)
                                                        <option value="{{ $item['id'] }}" {{ (old('hair_color') == $item['id']) ? 'selected' : '' }}>{{ $item['title'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-6 col-12 mb-2">
                                                ...
                                                <select class="form-select" id="select-hairy" name="hairy">
                                                    @foreach($data['main_data']['hairy'] as $item)
                                                        <option value="{{ $item['id'] }}" {{ (old('hairy') == $item['id']) ? 'selected' : '' }}>{{ $item['title'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_individuals_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-individuals" name="s_individuals" {{ old('s_individuals') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_premium_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-premium" name="s_premium" {{ old('s_premium') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_health_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-health" name="s_health" {{ old('s_health') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_elite_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-elite" name="s_elite" {{ old('s_elite') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_bdsm_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-bdsm" name="s_bdsm" {{ old('s_bdsm') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline ms-0 me-2 {{ ($data['post_section_masseuse_status']) ? '' : 'd-none' }}">
                                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-s-masseuse" name="s_masseuse" {{ old('s_masseuse') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                @foreach($data['main_data']['services_for'] as $service)
                                                    <div class="form-check form-check-inline ms-0 me-2">
                                                        <input class="form-check-input" type="checkbox" value="{{ $service['id'] }}" id="checkbox-services-for-{{ $service['id'] }}" name="services_for[]" {{ (old('services_for') && in_array($service['id'], old('services_for'))) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                @foreach($data['main_data']['body_art'] as $body_art)
                                                    <div class="form-check form-check-inline ms-0 me-2">
                                                        <input class="form-check-input" type="checkbox" value="{{ $body_art['id'] }}" id="checkbox-body_art-{{ $body_art['id'] }}" name="body_art[]" {{ (!empty(old('body_art')) && in_array($body_art['id'], old('body_art'))) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="checkbox-body_art-{{ $body_art['id'] }}">{{ $body_art['title'] }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                @foreach($data['main_data']['language_skills'] as $language_skill)
                                                    <div class="form-check form-check-inline ms-0 me-2">
                                                        <input class="form-check-input" type="checkbox" value="{{ $language_skill['id'] }}" id="checkbox-language-skills-{{ $language_skill['id'] }}" name="language_skills[]" {{ (is_array(old('language_skills')) && in_array($language_skill['id'], old('language_skills'))) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="space-x-2">
                                                @foreach($data['main_data']['tags'] as $tag)
                                                    <div class="form-check form-check-inline ms-0 me-2">
                                                        <input class="form-check-input" type="checkbox" value="{{ $tag['id'] }}" id="checkbox-tags-{{ $tag['id'] }}" name="tags[]" {{ (is_array(old('tags')) && in_array($tag['id'], old('tags'))) ? 'checked' : '' }}>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content">
                        ...
                        <script>
                            ...
                            var defaultZoom = @if(!empty(old('latitude')) && !empty(old('longitude'))) 15 @else 12 @endif;
                            var initialCoords = @if(!empty(old('latitude')) && !empty(old('longitude'))) [{{ old('latitude') }}, {{ old('longitude') }}] @else cities[firstKey] @endif;
                            var map = L.map('map').setView(initialCoords, defaultZoom);
                            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                                attribution: '&copy; OcEx.Dev'
                            }).addTo(map);

                            var marker; // Инициализируем переменную для маркера
                            ...
                            function onMapClick(e) {
                                if (!marker) {
                                    ...
                                    marker.on('click', function() {
                                        ...
                                        marker = null; // Очищаем переменную
                                        document.getElementById('input-latitude').value = ''; // Очищаем поля ввода
                            ...
                            document.getElementById('select-city').addEventListener('change', function() {
                                ...
                                if (coords) {
                                    ...
                                    document.getElementById('input-latitude').value = coords[0].toFixed(4);
                                    document.getElementById('input-longitude').value = coords[1].toFixed(4);
                                }
                            });
                        </script>
                    </div>
                            ...
                            <div class="col-sm-4 col-12">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_day_in_one" name="price_day_in_one" value="{{ old('price_day_in_one') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_day_out_one" name="price_day_out_one" value="{{ old('price_day_out_one') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/posts/post.two_hours') }}</div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_day_in_two" name="price_day_in_two" value="{{ old('price_day_in_two') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_day_out_two" name="price_day_out_two" value="{{ old('price_day_out_two') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-12">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/posts/post.one_hour') }}</div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_night_in_one" name="price_night_in_one" value="{{ old('price_night_in_one') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_night_out_one" name="price_night_out_one" value="{{ old('price_night_out_one') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-2 col-4">{{ __('admin/posts/post.night') }}</div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_night_in_night" name="price_night_in_night" value="{{ old('price_night_in_night') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                    <div class="col-sm-4 col-4">
                                        <input type="text" class="form-control" id="input-price_night_out_night" name="price_night_out_night" value="{{ old('price_night_out_night') }}" placeholder="{{ $data['currency_symbol'] }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-12">
                                <div class="form-check form-check-inline ms-0 me-2">
                                    <input class="form-check-input" type="checkbox" value="1" id="checkbox-express-status" name="express" {{ old('express') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="checkbox-express-status">{{ __('admin/posts/post.express') }}</label>
                                </div>
                                <input type="text" class="form-control" id="input-express-price" name="express_price" value="{{ old('express_price') }}" placeholder="{{ $data['currency_symbol'] }}">
                            </div>
                        </div>
                        <div class="mb-2">
                            ...
                            <div class="space-x-2">
                                @foreach($data['main_data']['visit_places'] as $visit_place)
                                    <div class="form-check form-check-inline ms-0 me-2">
                                        <input class="form-check-input" type="checkbox" value="{{ $visit_place['id'] }}" id="checkbox-visit-places-{{ $visit_place['id'] }}" name="visit_places[]" {{ (old('visit_places') && in_array($visit_place['id'], old('visit_places'))) ? 'checked' : '' }}>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content">
                        <div class="mb-4">
                            <textarea class="form-control" id="example-textarea-input" name="description" rows="4" placeholder="{{ __('admin/posts/post.description') }}" required>{{ old('description') }}</textarea>
                                    ...
                                    <div class="ex_services_block">
                                        ...
                                        <div class="ex_services_block_items">
                                            @foreach($service['data'] as $item)
                                                @php $service_condition = old('services.'.$item['id'].'.condition'); @endphp
                                                <div class="ex_services_block_item">
                                                    <div class="ex_services_block_item_main">
                                                        ...
                                                        <div class="ex_services_block_item_price">
                                                            <input type="text" class="form-control form-control-sm" value="{{ old('services.'.$item['id'].'.price') }}" id="services_{{ $item['id'] }}_price" name="services[{{ $item['id'] }}][price]" onclick="activateRadio('services_{{ $item['id'] }}_3')" placeholder="{{ $data['currency_symbol'] }}" @if(empty($service_condition) || $service_condition == 1 || $service_condition == 2 || $service_condition == 4) disabled @endif>
                                                        </div>
                                                    </div>
                                                    <div class="ex_services_block_item_description" style="display:@if(!empty($service_condition) && $service_condition != 4) block @else none @endif">
                                                        <input type="text" class="form-control form-control-sm" id="textarea-services-{{ $item['id'] }}-description" name="services[{{ $item['id'] }}][description]" value="{{ old('services.'.$item['id'].'.description') }}" placeholder="{{ __('admin/posts/post.description_service') }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                    ...
                    <div class="block-content tab-content">
                        ...
                        @if($data['main_data']['selfie_status'])
                            <div class="tab-pane" id="block-selfie" role="tabpanel">
                                ...
                                <div class="ex-post-selfie-all-media row">
                                    @php $old_selfies = old('images.selfies'); @endphp
                                        ...
                                        @foreach($old_selfies as $selfies)
                                            <div class="col-sm-2 col-4">
                                                <div class="ex_images_item_block" style="background-image: url('{{ $selfies }}')">
                                                    ...
                                                    <button type="button" data-types="selfie" data-file-path="{{ $selfies }}" class="ex_images_item_block_button post_btn_del"><i class="fa-solid fa-trash"></i></button>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                        ...
                        <div class="tab-pane" id="block-video" role="tabpanel">
                            ...
                            <div class="ex-post-video-all-media row">
                                @php $old_videos = old('videos'); @endphp
                                    ...
                                    @foreach($old_videos as $videos)
                                        <div class="col-sm-2 col-4">
                                            <div class="ex_video_item_block">
                                                ...
                                                <button type="button" data-types="videos" data-file-path="/{{ $videos }}" class="ex_video_item_block_button post_btn_del"><i class="fa-solid fa-trash"></i></button>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-12">
                                    <div class="d-flex justify-content-center mb-2">
                                        <div id="upload-container-verify" class="upload-container" style="display: {{ old('images.verify') ? 'none' : 'flex' }}">
                                        ...
                                        <div id="preview-container-verify" class="preview-container" style="display: {{ old('images.verify') ? 'flex' : 'none' }};">
                                            <img id="preview-image-verify" src="{{ old('images.verify') }}" alt="Preview" class="preview-img"/>
                                            <button type="button" class="delete-preview" onclick="deletePreviewImage('verify')"><i class="fa fa-trash"></i> {{ __('buttons.delete') }}</button>
                                        </div>
                                        <input type="hidden" name="images[verify]" id="image-path-verify" value="{{ old('images.verify') }}">
                                    </div>
                                </div>
                                <div class="col-sm-9 col-12">
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-diamond-status-1" name="diamond" value="0" {{ (old('diamond') == 0) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-diamond-status-1">{{ __('lang.status_off') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-diamond-status-2" name="diamond" value="1" {{ (old('diamond') == 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <input type="date" class="form-control" id="input-diamond-date" name="diamond_date" value="{{ old('diamond_date') }}" placeholder="{{ __('admin/posts/post.diamond_date') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-vip-status-1" name="vip" value="0" {{ (old('vip') == 0) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-vip-status-1">{{ __('lang.status_off') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-vip-status-2" name="vip" value="1" {{ (old('vip') == 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <input type="date" class="form-control" id="input-vip-date" name="vip_date" value="{{ old('vip_date') }}" placeholder="{{ __('admin/posts/post.vip_date') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-color-status-1" name="color" value="0" {{ (old('color') == 0) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-color-status-1">{{ __('lang.status_off') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-color-status-2" name="color" value="1" {{ (old('color') == 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <input type="date" class="form-control" id="input-color-date" name="color_date" value="{{ old('color_date') }}" placeholder="{{ __('admin/posts/post.color_date') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-verify-status-1" name="verify" value="0" {{ (old('verify') == 0) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-verify-status-1">{{ __('lang.status_off') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-verify-status-2" name="verify" value="1" {{ (old('verify') == 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <select class="form-select" name="moderation_id">
                                    @foreach($data['main_data']['moderation'] as $moder)
                                        <option value="{{ $moder['id'] }}" {{ (old('moderation_id') == $moder['id']) ? 'selected' : '' }}>{{ $moder['title'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 mb-2">
                                <label class="form-label">{{ __('admin/posts/post.moderation_txt') }}</label>
                                <textarea class="form-control" id="textarea-moderation-text" name="moderation_text" rows="4" placeholder="{{ __('admin/posts/post.moderation_txt') }}">{{ old('moderation_text') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-publish-status-1" name="publish" value="0" {{ (old('publish') == 0) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-publish-status-1">{{ __('lang.no') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-publish-status-2" name="publish" value="1" {{ (old('publish') == 1) ? 'checked' : '' }}>
                            ...
                            @if($data['post_activation_status'])
                                <div class="col-sm-3 col-12 mb-2">
                                    <label class="form-label" for="input-vip-date">{{ __('admin/posts/post.publish_date') }}</label>
                                    <input type="date" class="form-control" id="input-activation-date" name="publish_date" value="{{ old('publish_date') ?? date('Y-m-d') }}" placeholder="{{ __('admin/posts/post.publish_date') }}">
                                    <script>
