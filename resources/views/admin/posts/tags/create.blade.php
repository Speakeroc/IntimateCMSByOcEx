...
@section('content')
    <main id="main-container">
        ...
        <div class="content">
            <form action="{{ route('tags.store') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.tags_add') }}</h3>
