...
@section('content')
    <main id="main-container">
        <div class="bg-image" style="background-image: url('{{ url('images/admin/photo16@2x.jpg') }}');">
            <div class="content py-6">
                <h3 class="text-center text-white mb-0">
                    {{ __('admin/page_titles.payment_code_add') }}
                </h3>
            </div>
        </div>
        ...
        <div class="content">
            <form action="{{ route('payment_code.store') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.payment_code_add') }}</h3>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control" id="input-nominal" name="nominal" value="{{ old('nominal') }}" placeholder="{{ __('admin/pay/code.nominal') }} ({{ $data['currency_symbol'] }})">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                                    <label class="form-label" for="input-bonus">{{ __('admin/pay/code.bonus_form') }} ({{ $data['currency_symbol'] }})</label>
                                    <input type="number" class="form-control" id="input-bonus" name="bonus" value="{{ old('bonus') }}" placeholder="{{ __('admin/pay/code.bonus_form') }} ({{ $data['currency_symbol'] }})">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="input-pay-link" name="pay_link" value="{{ old('pay_link') }}" placeholder="{{ __('admin/pay/code.pay_link') }}">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <textarea name="pin_codes" class="form-control" id="input-pin-codes" rows="10">{{ old('pin_codes') }}</textarea>
