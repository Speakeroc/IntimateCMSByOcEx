...
@section('content')
    <main id="main-container">
        <div class="bg-image" style="background-image: url('{{ url('images/admin/photo16@2x.jpg') }}');">
            <div class="content py-6">
                <h3 class="text-center text-white mb-0">
                    {{ __('admin/page_titles.salon_edit') }}
                </h3>
            </div>
        </div>
        ...
        <div class="content">
            <form action="{{ route('salon.update', $data['id']) }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="random_id" id="input-random-id" value="{{ old('random_id') ?? rand(100000, 9999999) }}">
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/page_titles.salon_edit') }}</h3>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <div class="d-flex justify-content-center position-relative mb-2">
                                    <div id="upload-container-main" class="upload-container" style="display: {{ old('images.main') ?? $data['image_main'] ? 'none' : 'flex' }}">
                                        ...
                                        <input type="file" id="image-upload-main" name="image_main" accept=".png,.jpeg,.jpg" style="display:none;" onchange="handleUploadImage(event, 'main')">
                                    </div>
                            ...
                            <div class="col-sm-9 col-12">
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        <!-- Users -->
                                        <div class="mb-2">
                                            <label class="form-label" for="select-user">{{ __('admin/salon/salon.user') }}</label>
                                            <select class="form-select" id="select-user" name="user_id">
                                                @foreach($data['main_data']['users'] as $user)
                                                    <option value="{{ $user['id'] }}" @if((old('user_id') ?? $data['user_id']) == $user['id']) selected @endif>{{ __('admin/salon/salon.user_r', ['login' => $user['login'], 'email' => $user['email']]) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!-- //Users -->
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="input-title" name="title" value="{{ old('title') ?? $data['title'] }}" placeholder="{{ __('admin/salon/salon.title_p') }}">
                                        </div>
                                        <!-- //Title -->
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <!-- Work Time -->
                                        <div class="mb-2">
                                            <label class="form-label" for="input-phone">{{ __('admin/salon/salon.work_time') }}</label>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <p class="mb-0 fs-7">{{ __('admin/salon/salon.delete_info') }}</p>
                                ...
                                <hr class="my-1">
                                <!-- Messengers -->
                                <label class="form-label" for="input-phone">{{ __('admin/salon/salon.messengers') }}</label>
                                <div class="row">
                ...
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/salon/salon.block_prices') }}</h3>
                    </div>
                    <div class="block-content">
                        <div class="row mb-2">
                            <div class="col-sm-4 col-12">
                ...
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/salon/salon.block_desc') }}</h3>
                    </div>
                    <div class="block-content">
                        <div class="mb-4">
                            <textarea class="form-control" id="example-textarea-input" name="desc" rows="4" placeholder="{{ __('admin/salon/salon.desc') }}">{{ old('desc') ?? $data['desc'] }}</textarea>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <script>
                            ...
                            document.querySelectorAll('#upload-post-photos').forEach(button => {
                ...
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">{{ __('admin/salon/salon.block_admin') }}</h3>
                    </div>
                    <div class="block-content">
                        <div class="row">
                            <div class="col-sm-3 col-12 mb-2">
                                <label class="form-label">{{ __('admin/salon/salon.up_date_status') }}</label>
                                <div class="space-x-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="radios-up-date-status-1">{{ __('admin/salon/salon.up_date_one') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radios-up-date-status-2" name="up_date" value="1" {{ ($up_date == 1) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="radios-up-date-status-2">{{ __('admin/salon/salon.up_date_two') }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-12 mb-2">
                                <label class="form-label">{{ __('admin/salon/salon.publish') }}</label>
                                <div class="space-x-2">
                            ...
                            @if($data['salon_activation_status'])
                                <div class="col-sm-3 col-12 mb-2">
                                    ...
                                    <label class="form-label" for="input-vip-date">{{ __('admin/salon/salon.publish_date') }}</label>
                                    <input type="date" class="form-control" id="input-activation-date" name="publish_date" value="{{ $publish_date }}" placeholder="{{ __('admin/salon/salon.publish_date') }}">
                                    <script>
