...
@section('content')
    ...
    <div class="container">
        ...
        <div class="ex_post_page_block">
            <form action="{{ route('client.auth.salon.update', ['id' => $data['id']]) }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-title" name="title" value="{{ old('title') ?? $data['name'] }}" placeholder="{{ __('admin/salon/salon.title_p') }}">
                                </div>
                                <!-- //Title -->
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-address" name="address" value="{{ old('address') ?? $data['address'] }}" placeholder="{{ __('admin/salon/salon.address_p') }}">
                                </div>
                                <!-- //Address -->
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control phone-mask" id="input-phone" name="phone" value="{{ old('phone') ?? $data['phone'] }}" placeholder="{{ __('admin/salon/salon.phone') }}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="input-phone-one">{{ __('admin/salon/salon.phone_one') }}</label>
                                    <input type="text" class="form-control phone-mask" id="input-phone-one" name="phone_one" value="{{ old('phone_one') ?? $data['phone_one'] }}" placeholder="{{ __('admin/salon/salon.phone_one') }}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="input-phone-two">{{ __('admin/salon/salon.phone_two') }}</label>
                                    <input type="text" class="form-control phone-mask" id="input-phone-two" name="phone_two" value="{{ old('phone_two') ?? $data['phone_two'] }}" placeholder="{{ __('admin/salon/salon.phone_two') }}">
                                </div>
                                <!-- //Phone -->
                            </div>
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="space-y-2 mb-2">
                                        @php $work_time_type = old('work_time_type') ?? $data['work_time_type']; @endphp
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="input-call-time-type-one" name="work_time_type" value="1" {{ ($work_time_type == 1) ? 'checked' : '' }}{{ (!$work_time_type) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="input-call-time-type-one">{{ __('admin/salon/salon.work_time_hours') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="input-call-time-type-two" name="work_time_type" value="2" {{ ($work_time_type == 2) ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <select class="form-select" id="select-call-time-from" name="work_time[time_from]">
                                                @for ($i = 0; $i <= 24; $i++)
                                                    <option value="{{ $i }}" {{ (old('work_time.time_from') ?? ($data['work_time']['time_from'] ?? null) == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            <select class="form-select" id="select-call-time-to" name="work_time[time_to]">
                                                @for ($i = 0; $i <= 24; $i++)
                                                    <option value="{{ $i }}" {{ (old('work_time.time_to') ?? ($data['work_time']['time_to'] ?? null) == $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-delete-code" name="delete_code" value="{{ old('delete_code') ?? $data['delete_code'] }}" placeholder="{{ __('admin/salon/salon.delete_place') }}">
                                </div>
                                <!-- //Delete code -->
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-12">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_day_in_one" name="price_day_in_one" value="{{ old('price_day_in_one') ?? $data['price_day_in_one'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_day_in_two" name="price_day_in_two" value="{{ old('price_day_in_two') ?? $data['price_day_in_two'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-2 col-4">{{ __('admin/salon/salon.two_hours') }}</div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_day_out_one" name="price_day_out_one" value="{{ old('price_day_out_one') ?? $data['price_day_out_one'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_day_out_two" name="price_day_out_two" value="{{ old('price_day_out_two') ?? $data['price_day_out_two'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-2 col-4">{{ __('admin/salon/salon.one_hour') }}</div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_night_in_one" name="price_night_in_one" value="{{ old('price_night_in_one') ?? $data['price_night_in_one'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_night_in_night" name="price_night_in_night" value="{{ old('price_night_in_night') ?? $data['price_night_in_night'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-2 col-4">{{ __('admin/salon/salon.night') }}</div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_night_out_one" name="price_night_out_one" value="{{ old('price_night_out_one') ?? $data['price_night_out_one'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                            <div class="col-sm-4 col-4">
                                <input type="text" class="form-control" id="input-price_night_out_night" name="price_night_out_night" value="{{ old('price_night_out_night') ?? $data['price_night_out_night'] }}" placeholder="{{ __('lang.from') . ' ' . $data['currency_symbol'] }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <textarea class="form-control" id="textarea-desc" name="desc" rows="4" placeholder="{{ __('admin/salon/salon.desc') }}">{{ old('desc') ?? $data['desc'] }}</textarea>
