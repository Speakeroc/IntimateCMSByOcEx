...
@section('content')
    ...
    <div class="container">
        ...
        <div class="ex_post_page_block">
            <form action="{{ route('client.auth.post.create') }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-3 col-12">
                        ...
                        <div class="d-flex justify-content-center position-relative mb-2">
                            <div id="upload-container-main" class="upload-container" style="display: {{ old('images.main') ? 'none' : 'flex' }}">
                                ...
                                <svg class="ex_upload_preview"><use xlink:href="#icon-upload-preview"></use></svg>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-name" name="name" value="{{ old('name') }}" placeholder="{{ __('admin/posts/post.name_p') }}">
                                </div>
                                <!-- //Name -->
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-phone" name="phone" value="{{ old('phone') }}" placeholder="+7 (___) ___-__-__">
                                </div>
                                <!-- //Phone -->
                            </div>
                            <div class="col-sm-6 col-12">
                                ...
                                <!-- Delete code -->
                                <div class="mb-2">
                                    <label for="input-delete-code" class="form-label">{{ __('admin/posts/post.delete_code') }}</label>
                                    <small class="mb-0 fs-14 mb-2">{{ __('admin/posts/post.delete_info') }}</small>
                                    <input type="text" class="form-control" id="input-delete-code" name="delete_code" value="{{ old('delete_code') }}" placeholder="{{ __('admin/posts/post.delete_place') }}">
                                </div>
                                <!-- //Delete code -->
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="row">
                                    <div class="col-sm-4 col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="input-age" name="age" value="{{ old('age') }}" placeholder="{{ __('admin/posts/post.prefix_age') }}">
                                    </div>
                                    <div class="col-sm-4 col-6 mb-2">
                                        <label class="form-label" for="input-weight">{{ __('admin/posts/post.weight') }}</label>
                                        <input type="text" class="form-control" id="input-weight" name="weight" value="{{ old('weight') }}" placeholder="{{ __('admin/posts/post.prefix_weight') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="input-height" name="height" value="{{ old('height') }}" placeholder="{{ __('admin/posts/post.prefix_sm') }}">
                                    </div>
                                    <div class="col-sm-4 col-6 mb-2">
                                        <label class="form-label" for="input-breast">{{ __('admin/posts/post.breast') }}</label>
                                        <input type="text" class="form-control" id="input-breast" name="breast" value="{{ old('breast') }}" placeholder="{{ __('admin/posts/post.prefix_size') }}">
                                    </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="space-x-2">
                                        @foreach($data['main_data']['body_art'] as $body_art)
                                            <div class="form-check form-check-inline ms-0 me-2">
                                                <input class="form-check-input" type="checkbox" value="{{ $body_art['id'] }}" id="checkbox-body_art-{{ $body_art['id'] }}" name="body_art[]" {{ (old('body_art') && in_array($body_art['id'], old('body_art'))) ? 'checked' : '' }}>
                ...
                <h3 class="block-title mt-3">{{ __('admin/posts/post.block_prices') }}</h3>
                <div class="row mb-2">
                ...
                <h3 class="block-title mt-3">{{ __('admin/posts/post.block_description') }}</h3>
                <div class="mb-4">
                    <textarea class="form-control" id="example-textarea-input" name="description" rows="4" placeholder="{{ __('admin/posts/post.description') }}">{{ old('description') }}</textarea>
                    <p class="text-gray-dark mb-0">{{ trans_choice('admin/posts/post.min_symbol', 100, ['num' => 100]) }}</p>
                </div>

                <hr>

                <h3 class="block-title mt-3">{{ __('admin/posts/post.block_services') }}</h3>
                            ...
                            <div class="ex_services_block">
                                ...
                                <div class="ex_services_block_items">
                                    @foreach($service['data'] as $item)
                                        @php $service_condition = old('services.'.$item['id'].'.condition') ?? null; @endphp
                                        @php $service_description = old('services.'.$item['id'].'.description') ?? null; @endphp
                                        @php $service_price = old('services.'.$item['id'].'.price') ?? null; @endphp
                ...
                <nav class="nav nav-pills flex-column flex-sm-row mt-4 mb-3">
                    ...
                    @if($data['main_data']['selfie_status'])
                        <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" href="#block-selfie" role="tab" aria-controls="block-selfie" aria-selected="false"><i class="fas fa-image-portrait"></i> {{ __('admin/posts/post.image_selfie') }} <span id="counter-selfies"></span></a>
                    @endif
                    <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" href="#block-video" role="tab" aria-controls="block-video" aria-selected="false"><i class="fas fa-video"></i> {{ __('admin/posts/post.image_video') }} <span id="counter-videos"></span></a>
                    <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" href="#block-verify" role="tab" aria-controls="block-verify" aria-selected="false"><i class="fas fa-square-check"></i> {{ __('admin/posts/post.image_verify') }}</a>
                </nav>
