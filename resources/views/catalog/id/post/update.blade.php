...
@section('content')
    ...
    <div class="container">
        ...
        <div class="ex_post_page_block">
            <form action="{{ route('client.auth.post.update', ['id' => $data['id']]) }}" method="post" id="form-save" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-name" name="name" value="{{ old('name') ?? $data['name'] }}" placeholder="{{ __('admin/posts/post.name_p') }}">
                                </div>
                                <!-- //Name -->
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-phone" name="phone" value="{{ old('phone') ?? $data['phone'] }}" placeholder="+7 (___) ___-__-__">
                                </div>
                                <!-- //Phone -->
                            </div>
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="input-delete-code" name="delete_code" value="{{ old('delete_code') ?? $data['delete_code'] }}" placeholder="{{ __('admin/posts/post.delete_place') }}">
                                </div>
                                <!-- //Delete code -->
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="row">
                                    <div class="col-sm-4 col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="input-age" name="age" value="{{ old('age') ?? $data['age'] }}" placeholder="{{ __('admin/posts/post.prefix_age') }}">
                                    </div>
                                    <div class="col-sm-4 col-6 mb-2">
                                        <label class="form-label" for="input-weight">{{ __('admin/posts/post.weight') }}</label>
                                        <input type="text" class="form-control" id="input-weight" name="weight" value="{{ old('weight') ?? $data['weight'] }}" placeholder="{{ __('admin/posts/post.prefix_weight') }}">
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="input-height" name="height" value="{{ old('height') ?? $data['height'] }}" placeholder="{{ __('admin/posts/post.prefix_sm') }}">
                                    </div>
                                    <div class="col-sm-4 col-6 mb-2">
                                        <label class="form-label" for="input-breast">{{ __('admin/posts/post.breast') }}</label>
                                        <input type="text" class="form-control" id="input-breast" name="breast" value="{{ old('breast') ?? $data['breast'] }}" placeholder="{{ __('admin/posts/post.prefix_size') }}">
                                    </div>
                ...
                <div class="mb-4">
                    <textarea class="form-control" id="example-textarea-input" name="description" rows="4" placeholder="{{ __('admin/posts/post.description') }}">{{ old('description') ?? $data['description'] }}</textarea>
